...
2. Apply the two templates together with six-digit OTP length and 600-second expiry. Template copy and server expiry must agree. Keep email confirmation required.
