...
resources=['RiseBake/Assets.xcassets','RiseBake/Resources/seed.json','RiseBake/PrivacyInfo.xcprivacy','RiseBake/Resources/AuthConfig.json']
refs=[];srcs=[];res=[]
